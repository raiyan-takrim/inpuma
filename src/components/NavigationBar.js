...
const SearchBar = ({ className }) => {
    return (
        <div className={cn("p-4 bg-[--link] ml-auto grid place-items-center", className)}>
            <Dialog>
                <DialogTrigger><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <form className="flex items-center justify-center py-4">
                            ...
                            <button
                                type="submit"
                                className="ml-2 p-2 bg-[--link] text-white rounded-md hover:bg-[--link-hover]"
                            >
                                Search
                            </button>
                        </form>
